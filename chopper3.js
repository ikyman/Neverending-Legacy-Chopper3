G.AddData({
    ...
    func:function()
    {
        ...
        */
        ...
        G.props['stoneToolsUsedOnCanOpen'] = 0.2;
        G.props['knappedToolsUsedOnCanOpen'] = 0.5;
        ...
        G.funcs['ruler name easter egg blurb'] = function(){
            let rulerName = G.getName('ruler');
            let retString = rulerName;
        ...
        {
            var str='Your name is '+ G.funcs['ruler name easter egg blurb']() +', ruler of '+G.getName('civ')+'. Your tribe is primitive, but full of hope.<br>The first year of your legacy has begun. May it stand the test of time.';
                ...
                if (me.amount>0)
                {
                    ...
                    if (tick%3==0 && G.checkPolicy('disable eating')=='off')
                    {
                        ...
                        if (G.getRes('stone tools').amount <= 0 || G.getRes('knapped tools').amount <= 0 ) {
                            G.setPolicyModeByName('can opening','off');
                        }
